...
ax.text(0.055, 1.0, r'\textbf{a}', transform=ax.transAxes,
        fontsize=18, fontweight='bold', va='top', ha='right', color='black')
ax.text(0.055, 0.47, r'\textbf{b}', transform=ax.transAxes,
        fontsize=18, fontweight='bold', va='top', ha='right', color='black')

# ---------------- Figure save and show ----------------
file_path = os.path.join(fig_save_dir, f"Fig_waveguide_design.png")
if save_fig:
