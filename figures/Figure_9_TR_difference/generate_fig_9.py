...
# IQ_avg_matrix = np.load(os.path.join(home_dir, f"308_IQ_avg_matrix_0.npy"))
IQ_avg_matrix = np.load(os.path.join(home_dir,r"Shipley_T_fine_IQ_avg_matrix_0.npy"))
...
ax_top.set_xlim([2.9, 3.6])  # adjust as needed
...
ax_right.text(
    text_box_x, text_box_y, "Transmission",  # position in axes coordinates
...
# IQ_avg_matrix = np.load(r"C:\Users\chris\Desktop\TLS paper\Experiment data for Figures\Appendix_TR_difference\matrix_npy\Shipley_R_fine_IQ_avg_matrix_0.npy")
IQ_avg_matrix = np.load(os.path.join(home_dir,r"Shipley_R_fine_IQ_avg_matrix_0.npy"))
I_avg_matrix = IQ_avg_matrix[0]
Q_avg_matrix = IQ_avg_matrix[1]
...
ax_right.text(
    text_box_x, text_box_y, "Reflection",  # position in axes coordinates
    transform=ax_right.transAxes,
    fontsize=text_box_font_size,
    ha='right', va='bottom',
    color='black',
...
file_path = os.path.join(fig_save_dir, f"Fig_T_R_compare.png")
if save_fig:
