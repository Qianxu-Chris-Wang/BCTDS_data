...
# ax.set_ylim(0, 1)
ax.axis('off')
ax.text(0.055, 1.10, r'(a)', transform=ax.transAxes,
...
ax_right.text(bcd_x-0.009, bcd_y, r'(c)', transform=ax_right.transAxes,
             fontsize=abcd_size, fontweight='bold', va='top', ha='right', color='black')
...
ax_right.text(bcd_x, bcd_y, r'(d)', transform=ax_right.transAxes,
             fontsize=abcd_size, fontweight='bold', va='top', ha='right', color='black')
...
ax_right.text(bcd_x+0.0005, 1.33, r'(b)', transform=ax_right.transAxes,
             fontsize=abcd_size, fontweight='bold', va='top', ha='right', color='black')
