...
ax.text(ab_x, ac_y, r'(a)', transform=ax.transAxes, fontsize=abc_size, fontweight='bold', va='top', ha='right', color='black')
ax.text(ab_x, 0.49, r'(b)', transform=ax.transAxes, fontsize=abc_size, fontweight='bold', va='top', ha='right', color='black')
ax.text(0.52, ac_y, r'(c)', transform=ax.transAxes, fontsize=abc_size, fontweight='bold', va='top', ha='right', color='black')

ax.text(0.74, i_ii_y, r'(i)', transform=ax.transAxes, fontsize=i_ii_size, fontweight='bold', va='top', ha='right', color='black')
ax.text(0.96, i_ii_y, r'(ii)', transform=ax.transAxes, fontsize=i_ii_size, fontweight='bold', va='top', ha='right', color='black')
...
# print(f"Figure dimensions: {width:.2f} in × {height:.2f} in")
plt.close()
