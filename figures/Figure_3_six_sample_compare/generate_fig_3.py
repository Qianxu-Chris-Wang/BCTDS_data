...
ax_left.text(abcd_x_left, abcd_y, r'(a)', transform=ax_left.transAxes,
...
ax_left.text(abcd_x_right, abcd_y, r'(b)', transform=ax_left.transAxes,
             fontsize=abcd_size, fontweight='bold', va='top', ha='right', color='black')
...
ax_left.text(abcd_x_left, abcd_y, r'(c)', transform=ax_left.transAxes,
             fontsize=abcd_size, fontweight='bold', va='top', ha='right', color='black')
...
ax_left.text(abcd_x_right, abcd_y, r'(d)', transform=ax_left.transAxes,
             fontsize=abcd_size, fontweight='bold', va='top', ha='right', color='black')
...
ax_left.text(abcd_x_left, abcd_y, r'(e)', transform=ax_left.transAxes,
             fontsize=abcd_size, fontweight='bold', va='top', ha='right', color='black')
...
ax_left.text(abcd_x_right, abcd_y, r'(f)', transform=ax_left.transAxes,
             fontsize=abcd_size, fontweight='bold', va='top', ha='right', color='black')
...
# fig.text(0.49, 0.95, r'(b)', fontsize=40)
# fig.text(-0.02, 0.45, r'(c)', fontsize=40)
# fig.text(0.49, 0.45, r'(d)', fontsize=40)
